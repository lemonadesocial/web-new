...
export type GetEventTicketTypesQuery = { __typename: 'Query', getEventTicketTypes: { __typename: 'GetEventTicketTypesResponse', ticket_types: Array<{ __typename: 'PurchasableTicketType', _id: any, title: string, default?: boolean | null, description?: string | null, event: any, limited?: boolean | null, limit: number, whitelisted?: boolean | null, category?: any | null, position?: number | null, passcode_enabled?: boolean | null, prices: Array<{ __typename: 'EventTicketPrice', cost: string, currency: string, default?: boolean | null, payment_accounts?: Array<any> | null, payment_accounts_expanded?: Array<(
          { __typename: 'NewPaymentAccount' }
          & { ' $fragmentRefs'?: { 'PaymentAccountFragment': PaymentAccountFragment } }
...
export type UpdateEventSelfVerificationMutationVariables = Exact<{
  id: Scalars['MongoID']['input'];
  application_self_verification: Scalars['Boolean']['input'];
  required: Scalars['Boolean']['input'];
}>;


export type UpdateEventSelfVerificationMutation = { __typename: 'Mutation', updateEvent: { __typename: 'Event', application_self_verification?: boolean | null, application_self_verification_required?: boolean | null } };
...
export const UpdateEventSelfVerificationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateEventSelfVerification"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MongoID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"application_self_verification"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"required"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"updateEvent"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"application_self_verification"},"value":{"kind":"Variable","name":{"kind":"Name","value":"application_self_verification"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"application_self_verification_required"},"value":{"kind":"Variable","name":{"kind":"Name","value":"required"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"application_self_verification"}},{"kind":"Field","name":{"kind":"Name","value":"application_self_verification_required"}}]}}]}}]} as unknown as DocumentNode<UpdateEventSelfVerificationMutation, UpdateEventSelfVerificationMutationVariables>;
