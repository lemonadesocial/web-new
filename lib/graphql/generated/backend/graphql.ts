...
export type GetEventQuery = { __typename: 'Query', getEvent?: { __typename: 'Event', _id?: any | null, title: string, description?: string | null, approval_required?: boolean | null, start: any, end: any, shortid: string, host: any, cohosts?: Array<any> | null, accepted?: Array<any> | null, address_directions?: Array<string> | null, subevent_enabled?: boolean | null, space?: any | null, timezone?: string | null, guest_limit?: number | null, terms_text?: string | null, virtual?: boolean | null, virtual_url?: string | null, theme_data?: any | null, host_expanded?: (
      { __typename: 'User' }
