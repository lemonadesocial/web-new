...
export type GetSpaceQuery = { __typename: 'Query', getSpace?: (
    { __typename: 'Space' }
    & { ' $fragmentRefs'?: { 'SpaceFragmentFragment': SpaceFragmentFragment } }
  ) | null };
...
export type GetSpaceEventsQuery = { __typename: 'Query', getEvents: Array<{ __typename: 'Event', _id?: any | null, shortid: string, title: string, start: any, end: any, host_expanded?: { __typename: 'User', _id?: any | null, image_avatar?: string | null, name: string } | null, address?: { __typename: 'Address', city?: string | null, country?: string | null, region?: string | null } | null, new_new_photos_expanded?: Array<{ __typename: 'File', _id?: any | null, bucket: string, key: string, type: string, url: string } | null> | null, event_ticket_types?: Array<{ __typename: 'EventTicketType', _id: any, prices: Array<{ __typename: 'EventTicketPrice', cost: string, currency: string, default?: boolean | null }> }> | null }> };
