...
import { Address, File, Space } from '$lib/graphql/generated/backend/graphql';
...
import { EventFormValue, getLocation, isValidUrl, OptionLineItem, PUBLIC_OPTIONS } from './utils';
...
export function CreateEventForm({
  ...
  setValue: UseFormSetValue<EventFormValue>;
  spaces: Space[];
  listToSpace?: Space;
  /** @description support for small view such as pane */
  mobile?: boolean;
}>) {
