  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      >
        ...
        <div className="relative p-6 md:p-12 flex flex-col items-center gap-4 md:gap-6 h-full min-h-50">
          <div className="flex-1 flex items-center justify-center">
            <img
              src={`${ASSET_PREFIX}/assets/images/red-envelope-packs/received-fg.png`}
              alt=""
              className="w-32.75 md:w-56 h-auto object-contain"
            />
          </div>
          <div className="space-y-2 text-white">
            ...
            <p className="text-secondary text-center max-w-100">
