...
export function EventMappingEditor() {
  ...
  const lemonadeFields = getLemonadeFields('event');
  const externalFields = getExternalFields('event');
    ...
    <Card.Root>
      <Card.Header className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <i aria-hidden="true" className="icon-calendar size-5 text-secondary" />
          <h3 className="font-semibold text-sm">Event Field Mapping</h3>
        </div>
