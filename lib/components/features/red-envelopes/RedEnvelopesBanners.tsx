  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div
        ...
        onClick={() => {
          if (receivedCount > 0) {
            router.push('/red-envelopes/envelopes');
          }
        }}
      >
        <div className="absolute inset-0">
          <img
            src="/assets/images/red-envelope-packs/received-bg.png"
            alt=""
        ...
        <div className="relative p-12 flex flex-col items-center gap-6 h-full min-h-[200px]">
          <div className="flex-1 flex items-center justify-center">
            <img
              src="/assets/images/red-envelope-packs/received-fg.png"
              alt=""
      ...
      <div className="relative rounded-md overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/assets/images/red-envelope-packs/empty-bg.png"
            alt=""
            className="w-full h-full object-cover"
          />
        </div>
        <div className="relative p-12 flex flex-col items-center gap-6 h-full min-h-[200px]">
          <div className="flex-1 flex items-center justify-center">
            <img
              src="/assets/images/red-envelope-packs/empty-fg.png"
              alt=""
              className="max-w-[224px] h-auto object-contain"
            />
          </div>
          ...
          <Button
            ...
            onClick={(e) => {
              e.stopPropagation();
              router.push('/red-envelopes/send');
            }}
          >
            Fill & Send
          </Button>
