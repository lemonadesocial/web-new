...
export function FeedPost({ post, isComment, onSelect}: FeedPostProps) {
  ...
  return (
    <div className="space-y-2">
      <div className={twMerge("bg-card rounded-md border border-card-border px-4 py-3 space-y-3", clsx(onSelect && 'cursor-pointer hover:boder-card-boder-hover'))}  onClick={onSelect}>
