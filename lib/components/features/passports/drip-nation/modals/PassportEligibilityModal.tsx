...
import { formatWallet, AbstractPassportContract } from '$lib/utils/crypto';
...
export function PassportEligibilityModal({ onContinue }: { onContinue: () => void }) {
  ...
  if (balanceLoading) {
    return (
      <ConfirmTransaction
        ...
        description="We're checking if you already own a Drip Nation Passport. This may take a moment."
      />
    );
  }
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-secondary">
              You already own a Drip Nation Passport. Each wallet can only mint one passport.
            </p>
          </div>
  ...
  if (whitelistLoading) {
    return (
      <ConfirmTransaction
        title="Checking Your Access"
        description="We're checking if you're on the Drip Nation whitelist. This may take a moment."
      />
    );
  }
  ...
  if (whitelistData?.canMintPassport.can_mint) {
    return (
      <SuccessModal
        ...
        description="You can now personalize your Drip Nation Passport to make it truly yours before minting your on-chain identity."
        buttonText="Continue"
        onClose={onContinue}
      />
    );
    ...
    <ModalContent>
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-secondary">
            You're not whitelisted to mint your Drip Nation Passport yet. Register to the Drip Nation Launch to secure
            your spot.
          </p>
        </div>
