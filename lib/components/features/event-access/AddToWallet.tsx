      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between">
          <a href={getTicketPassUrl(ticket, 'apple')} target="_blank">
            <img src={`${ASSET_PREFIX}/assets/images/add-to-apple-wallet.png`} className="h-11" alt="Add to Apple Wallet" />
          </a>
          <a href={getTicketPassUrl(ticket, 'google')} target="_blank">
            <img src={`${ASSET_PREFIX}/assets/images/add-to-google-wallet.png`} className="h-11" alt="Add to Google Wallet" />
          </a>
        </div>
      </div>
    </ModalContent>
