...
> = {
  ...
  [TraitType.necklace]: { mutualExclusive: [TraitType.tie], filterTypes: [FilterType.size, FilterType.color] },
  [TraitType.tie]: { mutualExclusive: [TraitType.necklace], filterTypes: [] },
