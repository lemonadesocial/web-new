    ...
    >
      ...
      >
        <div style={{ display: 'flex' }}>
          <p style={{ fontSize: 40, fontFamily: 'Syne Tactile', color: 'rgba(255, 255, 255)', margin: 0, padding: 0 }}>Zu-Grāma</p>
        </div>
        <LemonadeLogo />
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        <p style={{ fontSize: 56, fontFamily: 'Syne Regular', color: 'rgba(255, 255, 255, 0.80)', margin: 0, padding: 0 }}>Citizen</p>
