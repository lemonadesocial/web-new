...
import { Button, Checkbox, Chip, modal, toast, Menu, Segment, InputField } from '$lib/components/core';
import { ConnectWallet } from '$lib/components/features/modals/ConnectWallet';
import { ImportCSVModal } from '$lib/components/features/red-envelopes/modals/ImportCSVModal';
import {
  getListChains,
  writeContract,
  formatError,
  ...
  return (
    <>
      <div className="w-full">
        ...
        <div className="flex items-center gap-2 py-3 px-4 border-b">
          ...
          <Button
            ...
            iconLeft="icon-plus"
            className="ml-auto"
            onClick={() => router.push('/red-envelopes')}
          >
            Buy Envelopes
          </Button>
        </div>
                  ...
                  >
                    <td className={rowCellClass}>
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <img
                          src="/assets/images/red-envelope-packs/1-envelope.png"
                          alt=""
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-[9] flex items-center justify-between px-4 py-3 bg-page-background-overlay border-t">
        <p className="text-sm text-tertiary">Select multiple rows to perform batch actions</p>
        <Button
          variant="secondary"
