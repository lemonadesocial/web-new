...
// ---- TypedDocumentNode stand-ins (generated by codegen) ----
// TODO: Replace with codegen-generated TypedDocumentNode imports after running `yarn codegen`.
// These are defined inline until codegen runs. They match the .gql operations
// in lib/graphql/gql/backend/session.gql and satisfy the TypedDocumentNode<T,V> shape.
...
const ACTIVE_SESSION_FRAGMENT = `
  fragment ActiveSession on Session {
    _id
    kratos_identity_id
    kratos_session_id
    device_name
...
const GetMyActiveSessionsDocument = parse(`
  ${ACTIVE_SESSION_FRAGMENT}
...
const RevokeMySessionDocument = parse(`
  ${ACTIVE_SESSION_FRAGMENT}
...
const RequestStepUpVerificationDocument = parse(`
...
const VerifyStepUpVerificationDocument = parse(`
...
const RevokeAllOtherSessionsDocument = parse(`
