...
export function HomePageContent() {
  ...
  return (
    <div className="space-y-5">
      ...
      {
        tab === 'Following' && (
          <Timeline account={account?.address} onSelectPost={onSelectPost} />
        )
      }
        ...
        tab === 'LemonHeads' && (
          <div className="flex gap-6 items-center flex-col mt-[108px]">
            ...
            <div className="space-y-2">
              ...
              <div>
              <p className="text-secondary text-center">An exclusive space for LemonHeads to post, connect & socialize.</p>
      ...
      {
        tab === 'Global' && (
          <FeedPosts global={true} onSelectPost={onSelectPost} />
        )
      }
    </div>
  );
