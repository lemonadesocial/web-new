...
* add active sessions page with step-up OTP flow ([#1136](https://github.com/lemonadesocial/web-new/issues/1136)) ([6396d7e](https://github.com/lemonadesocial/web-new/commit/6396d7e016a2b574242a2cc1159ca8b181e1eb80))
* add AI manage shell and preview tabs to community manage ([99fc4ec](https://github.com/lemonadesocial/web-new/commit/99fc4ecf994e137a2e63e4fb4e0635173977d3f3))
* add InlineGrid and improve page builder drag-and-drop ([af61635](https://github.com/lemonadesocial/web-new/commit/af61635a6918a30e9844613b7ebf68cd08bc0186))
* **connector:** add locked-status UI + friendly rate-limit/lockout toasts (PR-11) ([#1150](https://github.com/lemonadesocial/web-new/issues/1150)) ([81f697b](https://github.com/lemonadesocial/web-new/commit/81f697b1f8071136ec1cc3eae79d856c1695d5d2))
* **connector:** update disconnectPlatform consumer for DisconnectResult schema (PR-8) ([#1146](https://github.com/lemonadesocial/web-new/issues/1146)) ([6b70f8c](https://github.com/lemonadesocial/web-new/commit/6b70f8c202e2de75b8b241ede78d4c36e7a268b3))
* data deserialize incorrect ([65d78ca](https://github.com/lemonadesocial/web-new/commit/65d78ca566fdf759c6f3b610a596d877e9317641))
* finalize theme migration and responsive widths with master integration ([c4163d3](https://github.com/lemonadesocial/web-new/commit/c4163d3bcf36c9441baad5509f1b60479ca414ca))
* guard custom domain for free spaces with upgrade modal ([66f9f81](https://github.com/lemonadesocial/web-new/commit/66f9f81513861d55566634a6aa8ef345333fea20))
* implement AI Designer and improve custom template creation ([#1135](https://github.com/lemonadesocial/web-new/issues/1135)) ([25177c4](https://github.com/lemonadesocial/web-new/commit/25177c4366d588700e6ddc3f18d726ef6eeb0ae6))
* implement event theme migration to page config stage 1 ([7c15be2](https://github.com/lemonadesocial/web-new/commit/7c15be25fd7727f1a8ab06cefce3dd21808b0611))
* implement event theme migration to page config stage 1 and responsive widths ([cc83829](https://github.com/lemonadesocial/web-new/commit/cc83829ac628bc908b0330d3f6771a0412b61cb1))
* implement responsive width logic using CSS variables and device-aware settings ([9f4c8f9](https://github.com/lemonadesocial/web-new/commit/9f4c8f9887277c65b8012e532efc6766a946547b))
* missing import ([e4e5f1a](https://github.com/lemonadesocial/web-new/commit/e4e5f1a0c6c3097438685e104417f3c54cd7da89))
* **page-builder:** add centered option back to Grid component ([2c89e49](https://github.com/lemonadesocial/web-new/commit/2c89e4903bf87952fd6e1d6de4a2de5ee340d770))
* **page-builder:** add customizable title to Gallery section ([7fb24b7](https://github.com/lemonadesocial/web-new/commit/7fb24b70ae98edd98f6bb686130018fe17c81540))
* **page-builder:** add default template reset, container centering option, and disable editor in manage tab ([a1b233f](https://github.com/lemonadesocial/web-new/commit/a1b233fd35b2fbe3960130c65962920f5dec2c2a))
* **page-builder:** add layout containers (Tabs, Accordion, Columns) and enhance Container settings ([8d4d99b](https://github.com/lemonadesocial/web-new/commit/8d4d99b2fe4b2f6c83f9ec972b99978476447369))
* **page-builder:** add Set Full button and clarify width/alignment logic ([bf3e541](https://github.com/lemonadesocial/web-new/commit/bf3e54144c01eb10a5671352766f24f5a0e8c48c))
* **page-builder:** allow event page to be full screen when using Craft.js layout ([42bb68d](https://github.com/lemonadesocial/web-new/commit/42bb68d0407f0916c6106df2c468bd1cbe89eda6))
* **page-builder:** enable full-width design and set centered content as system default ([0dd678f](https://github.com/lemonadesocial/web-new/commit/0dd678f2917434213f74525d847ee2a32985fbe0))
* **page-builder:** fix drag-to-side visibility and implement global drop zone tracking for sidebar drags ([7bca73b](https://github.com/lemonadesocial/web-new/commit/7bca73b0b8c3b164c3c243f7ff070351a4a633cb))
* **page-builder:** implement drag-to-side drop zones for automatic column creation and improve resize handles ([45a36b0](https://github.com/lemonadesocial/web-new/commit/45a36b0c14cc5177607320bcfa09fab82f6b60c4))
* **page-builder:** implement lazy loading and increased limit for Schedule section ([1bf7c5f](https://github.com/lemonadesocial/web-new/commit/1bf7c5f149090b1019bbb604edd803bb34813e2a))
* **page-builder:** implement smart split and multi-axis resizing handles ([92e4cd6](https://github.com/lemonadesocial/web-new/commit/92e4cd66a2b45e80af652d522c8b60f98a89badf))
* **page-builder:** improve horizontal section reordering with robust drop logic and vertical indicators ([d6bb5f4](https://github.com/lemonadesocial/web-new/commit/d6bb5f4cbcce56ec58d5b803f8e51b8d099457d6))
* **page-builder:** migrate page config from structure_data to sections[] ([8a71f37](https://github.com/lemonadesocial/web-new/commit/8a71f375c3c7858133af89cc1545b958201ee86d))
* **page-builder:** move default centering and width logic from ROOT to Grid for true full-screen support ([aae93b0](https://github.com/lemonadesocial/web-new/commit/aae93b0a7aed4712dcbc463a5612c4b0c5d315fc))
* **page-builder:** set default template width to 1080px and add width setting to container ([ef9e6cb](https://github.com/lemonadesocial/web-new/commit/ef9e6cb87e5e33ea3b5f0602979aa88ad4626ff9))
* **page-builder:** support flexible multi-column layout and larger side-drop zones ([fe1b4c3](https://github.com/lemonadesocial/web-new/commit/fe1b4c30a6d2560bb84ad3a252546c6099197345))
* **page-builder:** updatePageConfig on save + image banner aspect/fit settings ([246d8b2](https://github.com/lemonadesocial/web-new/commit/246d8b2223ea494825902799d7cdd55928f5f3b4))
* **page-config:** read/write theme on PageConfig, apply AI designer theme ([9e4a59d](https://github.com/lemonadesocial/web-new/commit/9e4a59da3bc416d5f76c67af5facac35918ffdb1))
* support responsive width property in Col component and settings ([64feec5](https://github.com/lemonadesocial/web-new/commit/64feec59684d80172fabb50b7a2f95827e8cf88c))
* update ai design tool ([7905c04](https://github.com/lemonadesocial/web-new/commit/7905c04fa6c8d6de4e864048ae1eccec612160a2))
* update missing SettingsPanel ([1eca8a8](https://github.com/lemonadesocial/web-new/commit/1eca8a8e706061e642ee546d5e7b56c5d6939f71))
* update ui save button ([2ea2f80](https://github.com/lemonadesocial/web-new/commit/2ea2f806b4e549a696f2d3afd5a02e267d312434))


### Bug Fixes

* address Karen review findings on web-new[#1144](https://github.com/lemonadesocial/web-new/issues/1144) ([d96fb72](https://github.com/lemonadesocial/web-new/commit/d96fb72ba6c97a1d58a8321970ee8146b7a236e2))
* **ai-manage:** add permission check and "No Access" UI ([d3a8775](https://github.com/lemonadesocial/web-new/commit/d3a87753a859a5dc7e7f8287c28e27db786e14c6))
* **ai:** use page designer config in design tool ([0d93777](https://github.com/lemonadesocial/web-new/commit/0d93777241e4ab8333de98e3e308ab914871e8dd))
* call backend revokeCurrentSession before Kratos logout ([#1140](https://github.com/lemonadesocial/web-new/issues/1140)) ([98bd813](https://github.com/lemonadesocial/web-new/commit/98bd813ede04c4b450bcb076205cd0122ce55625))
* correct community slug availability validation ([15621e6](https://github.com/lemonadesocial/web-new/commit/15621e6de8dac69ccd21b7f53bcd3374e1f38d79))
* correct type ([cf31d47](https://github.com/lemonadesocial/web-new/commit/cf31d47f7b42f59dae2fd57aede45cc5593d14bc))
* define maxWidth in Col component and ensure universal responsiveness ([be064cd](https://github.com/lemonadesocial/web-new/commit/be064cdbe8adcd8934f3c0771dfd531d269e9d15))
* ensure configs always populated and show welcome message in AI designer ([6a9f595](https://github.com/lemonadesocial/web-new/commit/6a9f59528ee74a86f5780784d0027478eb614192))
* **event:** fix initialization error for pageConfigFields in EventGuestSide ([6a8691c](https://github.com/lemonadesocial/web-new/commit/6a8691c50c039cb44058599bbc5852868201786f))
* **event:** replace missing react-intersection-observer with native IntersectionObserver ([e23fd66](https://github.com/lemonadesocial/web-new/commit/e23fd663630b010ab4bd267599f896b4810a66f4))
* fix codegen ([b581ad1](https://github.com/lemonadesocial/web-new/commit/b581ad12b56d2934bc993ecc1f4984e462197f8d))
* fix TypeScript type errors in page builder and AI manage components ([ff6fa77](https://github.com/lemonadesocial/web-new/commit/ff6fa77270081561b99035debdf2cb8eaadaa5c8))
* fix uneditable page designer when apply AI sections ([e79e84b](https://github.com/lemonadesocial/web-new/commit/e79e84b656fa77a6b33bb3e832cba4a1d585d181))
* **gql:** align session.gql with backend schema (camelCase args, ActiveSession type, scalar returns) ([#1147](https://github.com/lemonadesocial/web-new/issues/1147)) ([488165b](https://github.com/lemonadesocial/web-new/commit/488165b0ac029459b2f89c1f40fc32f8d19148d9))
* improve dnd ([bc36975](https://github.com/lemonadesocial/web-new/commit/bc3697517231ed281a1f49314d6294d228778185))
* improve mobile responsiveness by using maxWidth for fixed widths ([cdd5e58](https://github.com/lemonadesocial/web-new/commit/cdd5e5870501acfa2400452dbc237edd5316c00a))
* include email in user_expanded for getEventJoinRequests ([c60d2c9](https://github.com/lemonadesocial/web-new/commit/c60d2c9dc0cd3407deec4731bc2e56d9896eab22))
* lint type ([31652cd](https://github.com/lemonadesocial/web-new/commit/31652cd63c752b2ff5e2731454627408b519d707))
* nodesToSections returns ROOT as layout_container instead of its children ([b7ddc91](https://github.com/lemonadesocial/web-new/commit/b7ddc916f977870f603fcd98ea5605fa1ea760b3))
* **page-builder:** allow image aspect ratio to correctly determine height when height is auto ([ed741af](https://github.com/lemonadesocial/web-new/commit/ed741af88305e2f6c44fccb7088ebfd546b26dca))
* **page-builder:** attach orphaned top-level sections to ROOT node ([e32c395](https://github.com/lemonadesocial/web-new/commit/e32c395b2df89a9eb0ae37223d1b2300e568d245))
* **page-builder:** centralize structure_data formatting and ensure default props ([a1e5b94](https://github.com/lemonadesocial/web-new/commit/a1e5b94e87cc943e11792c3e4b0f37ae01ee6e4d))
* **page-builder:** cleanup centered prop and disable dashboard card interaction ([c8a1d0b](https://github.com/lemonadesocial/web-new/commit/c8a1d0beabda675ec6116426bcf907e02b4779ef))
* **page-builder:** completely disable interaction and edit UI for Container, Grid, and Col in preview mode ([dffee53](https://github.com/lemonadesocial/web-new/commit/dffee53b99aeb557835de4963f412087110ae10e))
* **page-builder:** connect SettingsPanel Save button to layout save logic ([2c13366](https://github.com/lemonadesocial/web-new/commit/2c13366881339548085670156adb8e710aae37fd))
* **page-builder:** ensure CraftSection respects editor enabled state to prevent interaction in preview mode ([608d633](https://github.com/lemonadesocial/web-new/commit/608d63372d93391eb96003b029df37eaad8a50df))
* **page-builder:** ensure ROOT Container is always full-width and centering is solely Grid-controlled ([97a578b](https://github.com/lemonadesocial/web-new/commit/97a578b799b81325dc5978c208f4cb1be6a3ee67))
* **page-builder:** ensure section wrapper respects aspect ratio ([7f7e2af](https://github.com/lemonadesocial/web-new/commit/7f7e2af5f71f9eb188155d758a15d01c7488e536))
* **page-builder:** ensure sidebar preset width is correctly applied ([604fb13](https://github.com/lemonadesocial/web-new/commit/604fb135042357415bc731babd4a1ba895dfeef1))
* **page-builder:** fix centered content option by using valid CSS classes ([f732be3](https://github.com/lemonadesocial/web-new/commit/f732be3999306f14dc60e879963b56fc7e22d7ac))
* **page-builder:** fix settings panel disappearance and implement column split functionality ([b5001d1](https://github.com/lemonadesocial/web-new/commit/b5001d12c2f0bef70a3576fbfdec6c59c1102cba))
* **page-builder:** fix theme scoping, radius alignment, and light mode background in preview ([ea1648b](https://github.com/lemonadesocial/web-new/commit/ea1648b8eef964f9e1fdcef9cc6719af0ddff93d))
* **page-builder:** fix Toggle component props in Container and Grid settings ([b526385](https://github.com/lemonadesocial/web-new/commit/b526385788f075b6669a808381a651638c1f0879))
* **page-builder:** fix width type-safety and ensure drop zones only show during active drag ([87d5da9](https://github.com/lemonadesocial/web-new/commit/87d5da965a1d8ea785df37cf097d99a69722bedc))
* **page-builder:** hide placeholder UI and empty sections from end users ([ed16ff2](https://github.com/lemonadesocial/web-new/commit/ed16ff235fb2e9cb174f4c941fc535486910e2c4))
* **page-builder:** improve UI/UX with better selection borders, all-directional resizing, and fixed layout nesting rules ([91a7e2a](https://github.com/lemonadesocial/web-new/commit/91a7e2ac1c46783dcbf9d6e09c0ed09e9e97bce1))
* **page-builder:** normalize AI layout root node ([7fcc1e8](https://github.com/lemonadesocial/web-new/commit/7fcc1e8e252785eda31e044e3a8c015a9bcd07f5))
* **page-builder:** restore missing section definitions in SectionTool ([b095116](https://github.com/lemonadesocial/web-new/commit/b095116c453a1073d259b89d79481209b31190b2))
* **page-builder:** restore pragmatic renderer after conflict resolution ([44bbf9e](https://github.com/lemonadesocial/web-new/commit/44bbf9e84b2e402b96d69a12d09b5653f2b74f18))
* **page-builder:** synchronize layout data structure and display names ([62e97e0](https://github.com/lemonadesocial/web-new/commit/62e97e087237bd34aa2d629631f06c42190039b2))
* **session:** migrate inline documents to codegen imports; fix runtime-broken field access ([#1148](https://github.com/lemonadesocial/web-new/issues/1148)) ([e529a68](https://github.com/lemonadesocial/web-new/commit/e529a6839e501ffa0c4d702d552a26197b692743))
...
* add connectors ([51a1f25](https://github.com/lemonadesocial/web-new/commit/51a1f25454d37c5d9bc7a8f0a204fc4273ff1653))
* add copy button input password ([d6aeca9](https://github.com/lemonadesocial/web-new/commit/d6aeca986083232bd560fae71c0a27bcd52a4110))
...
* add event layout ([313dc49](https://github.com/lemonadesocial/web-new/commit/313dc4913d0aad0f55000bdfbfd6dcd9e0099b58))
...
* add logo ([ca9cb93](https://github.com/lemonadesocial/web-new/commit/ca9cb93a06503ea8dac9085cb295f467cfde1d12))
...
* add not found when space had no agents ([fcc178e](https://github.com/lemonadesocial/web-new/commit/fcc178e10dfd1736f45a5746d6194ffc063fce17))
* add preview link route and GQL operations ([cc80ef9](https://github.com/lemonadesocial/web-new/commit/cc80ef9bec0eb11d7364529e171277f92477d308))
* add real connector icons for integrations ([506606c](https://github.com/lemonadesocial/web-new/commit/506606c82eebbcd9d1c0da0fe1259fc72f580bcc))
...
* add spotlight event list to messages ([2bcc77e](https://github.com/lemonadesocial/web-new/commit/2bcc77e12ca2ee6bd1c03737a849e552d2dcc465))
...
* **ai-chat:** refresh chat and home UI ([daa67fc](https://github.com/lemonadesocial/web-new/commit/daa67fc261fede7ea94248038fa3e073129a3b39))
...
* **ai:** animated placeholder for InputChat with setTimeout chain ([e3adf0f](https://github.com/lemonadesocial/web-new/commit/e3adf0fbf805463fd65a9c9838bc8c24b109bd66))
* align design and preview with event page mobile mode ([7e25d77](https://github.com/lemonadesocial/web-new/commit/7e25d77287ee07da9dd26ac49a8201b1853587b8))
...
* community api key settings ([184fc67](https://github.com/lemonadesocial/web-new/commit/184fc67ef4e988748889b06e671c2cb366c253ea))
* community vaults ([327f7e5](https://github.com/lemonadesocial/web-new/commit/327f7e5bb6732639989ee0fd3869707dae848eb7))
* complete plan and credits ([b98f123](https://github.com/lemonadesocial/web-new/commit/b98f12300da1845c4b52eaa332fd9aa3c74012b2))
* create new layout ([a329329](https://github.com/lemonadesocial/web-new/commit/a3293291b44ea531541088a871ab94ac27dd12bb))
...
* integrate api for create preview link ([47f7fa1](https://github.com/lemonadesocial/web-new/commit/47f7fa185a25ff5f2b1ae1251f0667ced37967e9))
...
* parallelizing with Promise.allSettled ([1598aee](https://github.com/lemonadesocial/web-new/commit/1598aeea683967129d9ee69a9e90b597fa6515b2))
...
* refine manage design panel and manual theme save flow ([a1c47c4](https://github.com/lemonadesocial/web-new/commit/a1c47c415fbdb175c9d9a7d69cf40ae66214b713))
* remove duplicate gql ([e9b51b1](https://github.com/lemonadesocial/web-new/commit/e9b51b1be68eb6c9df9df50242e0adec4400288d))
* remove unused ([2d686f0](https://github.com/lemonadesocial/web-new/commit/2d686f0258f658f02a7c1aa9c6bb9d635c0f3a79))
* remove unused ([a374d60](https://github.com/lemonadesocial/web-new/commit/a374d6013c47b01c617773d70d307d5fd132b4ba))
* remove unused ([41b1027](https://github.com/lemonadesocial/web-new/commit/41b1027154cf2bf90e9721808686424f911288ae))
* resize icon ([740848c](https://github.com/lemonadesocial/web-new/commit/740848c1648d0e9d66ed0735229879041266a624))
* resolve conflict ([6e5b58b](https://github.com/lemonadesocial/web-new/commit/6e5b58bd774e3936b41d6866ebe2f0b48efc78b7))
* resolve feedback ([664c415](https://github.com/lemonadesocial/web-new/commit/664c4152cc0ddacd32bd25188d371bc0230a8c99))
* seal ui ([8547a0a](https://github.com/lemonadesocial/web-new/commit/8547a0a0c916c324d7794ccb7bfdfc8fd964ccb7))
* **setting:** allow update oauth2 client redirect URLs ([023ef67](https://github.com/lemonadesocial/web-new/commit/023ef67c6586b988f1b62229a64e678685b4087e))
...
* update agent info modal ([fd787e3](https://github.com/lemonadesocial/web-new/commit/fd787e3ee1f2aed77a5055cf7ceef5147ad170ef))
* update agent list mobile view ([0133616](https://github.com/lemonadesocial/web-new/commit/0133616be3a37d33c45c59b68e41cd188bd6a1ee))
* update annual pricing ([85a5821](https://github.com/lemonadesocial/web-new/commit/85a5821f04c743f5fb5d946ab5a099081dfeff74))
* update button variant ([01c56cd](https://github.com/lemonadesocial/web-new/commit/01c56cd362b5a1213b46d1c4d56e84f77140ef2c))
...
* update community layout footer and mobile agent menu ([83092a5](https://github.com/lemonadesocial/web-new/commit/83092a5cc8a708916a8d4b2f255e5a39a1eb536c))
* update config ([c768ecb](https://github.com/lemonadesocial/web-new/commit/c768ecb9f81580b9894855c5acd6cbf93b41ada7))
...
* update create link preview mweb ([84163db](https://github.com/lemonadesocial/web-new/commit/84163db215412df41547076c6e2cbf69dfe5201d))
* update create preview link ([cfac61f](https://github.com/lemonadesocial/web-new/commit/cfac61f231b1038bccc35b8ecf52a21232200f3a))
* update deployment vars ([ca40ff3](https://github.com/lemonadesocial/web-new/commit/ca40ff358ade7d057980816b59e044af2cb60cb4))
* update dropdown menu ([204aca5](https://github.com/lemonadesocial/web-new/commit/204aca5cfafffb466a67b41fddcbc4e40a881e15))
...
* update icons ([34c74a2](https://github.com/lemonadesocial/web-new/commit/34c74a2952a3b4818c3846f625eff6eb4e3b4bc5))
* update layout ([ca41297](https://github.com/lemonadesocial/web-new/commit/ca4129715421a0f7287c6db98531cebb29c04c2e))
* update layout community ([d0480f8](https://github.com/lemonadesocial/web-new/commit/d0480f83c29afd397c370c920aee3a4237011e7b))
* update layout community guest ([8f807ad](https://github.com/lemonadesocial/web-new/commit/8f807ad1458dbd4c67b154181bb40878d3902ce0))
* update layout form detail community and team ([49f04a4](https://github.com/lemonadesocial/web-new/commit/49f04a4e15f2b1cbe5664676177adc6e1e15c33a))
* update layout InputChat ([c6b1275](https://github.com/lemonadesocial/web-new/commit/c6b127519b42af1dd9f2f1ac0bc935f555cf8019))
* update layout upgrade to pro ([9e5bce2](https://github.com/lemonadesocial/web-new/commit/9e5bce238f1451686855529486f886720b8902b7))
...
* update mobile menu ([0d93780](https://github.com/lemonadesocial/web-new/commit/0d93780b9760c43a70bbe8379290d51a8ea43d94))
* update payouts ui ([bf3f206](https://github.com/lemonadesocial/web-new/commit/bf3f206504c3b9bb998a6b015eaa7ebc90041306))
* update period handle ([de07b6e](https://github.com/lemonadesocial/web-new/commit/de07b6e59265f1ffd30979522ac8262b727a7da9))
...
* update RE home layout ([8e83ec9](https://github.com/lemonadesocial/web-new/commit/8e83ec95a616b9b87941adee47fa7c3930bbd465))
* update sent envelopes ui on mobile ([e51aa43](https://github.com/lemonadesocial/web-new/commit/e51aa4353b9916b052c999aad38f7e02af08b648))
...
* update sidebar ([6069a02](https://github.com/lemonadesocial/web-new/commit/6069a0247cdf74d15c428e271f5543a5b062dc15))
* update smoke test ([14a5ff7](https://github.com/lemonadesocial/web-new/commit/14a5ff79acc52292e36b7c9b86c70d0a9549d675))
* update space list allow ai chat community guest view ([1336e1a](https://github.com/lemonadesocial/web-new/commit/1336e1a58a1996671e6b9b204741c5b2c0cfd3d4))
...
* update type ([e0262ab](https://github.com/lemonadesocial/web-new/commit/e0262abb1f5cc892f583e1c29ed4cd733410e419))
* update ui create link preview ([6d513b1](https://github.com/lemonadesocial/web-new/commit/6d513b11131435543f8797fa6b84655b14ab03b0))
* update ui pricing ([198fe3c](https://github.com/lemonadesocial/web-new/commit/198fe3ce452d08ea3a1161134cade6aa64f169be))
* update ui sidebar ([8c0ef6e](https://github.com/lemonadesocial/web-new/commit/8c0ef6e8504d462de1fde6489fde1f3f08b0839d))
...
* update view mode mobile ([783f4d5](https://github.com/lemonadesocial/web-new/commit/783f4d5abb8817e387d0b565d1cc795476b838cd))
* update welcome message ([abaff29](https://github.com/lemonadesocial/web-new/commit/abaff2984de4e5697ccae85caf27e034850fd458))
* **upgrade-to-pro:** load subscription plans and render dynamic pricing ([b93a154](https://github.com/lemonadesocial/web-new/commit/b93a15463802c497f89735144b81f1e52e4b554e))
...
* address all 8 Karen review findings on web-new[#980](https://github.com/lemonadesocial/web-new/issues/980) ([551c847](https://github.com/lemonadesocial/web-new/commit/551c84762ca01c5268fca194d01c163c398794c1))
* address Karen findings — add AI_API_HTTP, fix DATABASE_URL description ([fe07617](https://github.com/lemonadesocial/web-new/commit/fe076176b71a0cac96f8f998a2067913d00ecca3))
* address Karen PR review findings on community vaults ([db8e45f](https://github.com/lemonadesocial/web-new/commit/db8e45f66e98b63dfea869c5957bf12a625d60d7))
...
* address PR comments for preview links ([c61ec47](https://github.com/lemonadesocial/web-new/commit/c61ec470dd9530b7291cdbef1bf5c834d997b173))
* address PR reviews for AI chat and reward dashboard ([9fa718c](https://github.com/lemonadesocial/web-new/commit/9fa718c20309fbe91021c19c1331ea9f470fad0a))
...
* **audit:** LOW-001 — replace dangerouslySetInnerHTML with unicode middot ([80865ce](https://github.com/lemonadesocial/web-new/commit/80865ce31cafe686642fc648d946d6c2ae9fe944))
* **audit:** LOW-003 — remove hardcoded contract address fallback ([acef10a](https://github.com/lemonadesocial/web-new/commit/acef10a4a6bf0461080eaa5b98d6fc85bab73ec6))
* **audit:** LOW-005 — add lang="en" to global-error.tsx html element ([ba4fe55](https://github.com/lemonadesocial/web-new/commit/ba4fe55a52f2f9f956df494728e94fd592362843))
* **audit:** LOW-006 — rename duplicate function definitions ([fb07f02](https://github.com/lemonadesocial/web-new/commit/fb07f02b028909a6a44933dcd823ec7be4255ca4))
* **audit:** LOW-009 — replace div role="button" with semantic button ([6a7e9bc](https://github.com/lemonadesocial/web-new/commit/6a7e9bc5bd40e41402de398d1d5f8161a8cc135d))
* **audit:** LOW-010 — remove unnecessary 'use client' from skeleton and radial ([d29c8bc](https://github.com/lemonadesocial/web-new/commit/d29c8bca9252b522c74f10ad5626bb9986af9228))
...
* bypass changed-file typecheck on OOM ([db251bb](https://github.com/lemonadesocial/web-new/commit/db251bbb4331ec603d6fd877df01dc70ad02ce11))
...
* centralize ai chat initialization in ManageEventLayout ([4ec27e4](https://github.com/lemonadesocial/web-new/commit/4ec27e494469a9d2e165bde422396a93d002d146))
* change /upgrade-to-pro to /upgrade/[slug] ([faff3c0](https://github.com/lemonadesocial/web-new/commit/faff3c0630919456857509e37e4c2e92a2006715))
* change expires_in_hours to expires_at in CreatePreviewLinkInput ([be21b90](https://github.com/lemonadesocial/web-new/commit/be21b901497938c9e0af05454fc678c8646eb554))
...
* check dirty state when edit theme ([2a17a43](https://github.com/lemonadesocial/web-new/commit/2a17a432bf7bb5e7b2204fd99640bd78d2c29f2e))
...
* **config:** remove duplicate .lintstagedrc.js — keep ESM .mjs only ([9086016](https://github.com/lemonadesocial/web-new/commit/9086016c0a79d1f84e0206a8e964bd63d88ced24))
* copy ([c870c1b](https://github.com/lemonadesocial/web-new/commit/c870c1b92de8d9dddce24fcc63e72d7acb4d84e7))
* correct cta ([fc725c4](https://github.com/lemonadesocial/web-new/commit/fc725c472692c32bcb1d47f621a994eb218452ca))
* correct passport chain ([6750c54](https://github.com/lemonadesocial/web-new/commit/6750c545f8f4b76469121f137823076428e3653b))
...
* event guest list - move actions to top ([edb72ff](https://github.com/lemonadesocial/web-new/commit/edb72ff712325701dbb21c225b03ce650535a7f0))
* event payment accounts can use space accounts ([b0dfa0d](https://github.com/lemonadesocial/web-new/commit/b0dfa0d220fc8fa488a7ad0e7ea0335c4258fe16))
...
* header community layout ([3b9b89e](https://github.com/lemonadesocial/web-new/commit/3b9b89e53e407bb4dac1bd97f0b446818af43338))
...
* icon not show ([d89fe34](https://github.com/lemonadesocial/web-new/commit/d89fe34f9c4d596ab3c5b7a434624fd870361e46))
...
* layout save changes CTA bar ([95139f0](https://github.com/lemonadesocial/web-new/commit/95139f09a83064338a7ce8a8319da6d0b6e529a5))
...
* padding manage event layout ([a68dbb3](https://github.com/lemonadesocial/web-new/commit/a68dbb3375e70336ea0434e85444f21edc31a09d))
...
* polish design panel spacing and action visibility ([9d04988](https://github.com/lemonadesocial/web-new/commit/9d04988be9f06dac8ad6ea37068b6c1915c8755f))
* polish ui link preview ([af24527](https://github.com/lemonadesocial/web-new/commit/af24527cd0d4d9a6c1657ec7439ed5de5bb3bea9))
* re main buttons ([e6c7d06](https://github.com/lemonadesocial/web-new/commit/e6c7d06d6e33bfbc03d1f0eb13eff96cd28d24a5))
...
* Remove event list from left navigation bar ([beccd85](https://github.com/lemonadesocial/web-new/commit/beccd8571de17f154bb00f2b64f63e80203ea0fd))
* remove hideHeader props ([7570d4d](https://github.com/lemonadesocial/web-new/commit/7570d4d974300d61e29379cc39e73725da67072e))
...
* remove unused props ([679841e](https://github.com/lemonadesocial/web-new/commit/679841e7ebced23da944449c335ea50e43b1eb44))
* remove unused props ([4ace9c1](https://github.com/lemonadesocial/web-new/commit/4ace9c1c6216c49459eca342420a1cedf20034f2))
* replace catch(error: any) with catch(error: unknown) across 46 files ([90a2792](https://github.com/lemonadesocial/web-new/commit/90a2792b654e4a20fd31a6522f092119bd1c0c0d))
* replace console.log/error with Sentry.captureException in catch blocks ([ed8c658](https://github.com/lemonadesocial/web-new/commit/ed8c65828c9d8098ed0ea24c80b6aac3be2c7ed2))
* replace useMutation with useQuery for Stripe account lookup ([2ba5ee1](https://github.com/lemonadesocial/web-new/commit/2ba5ee164db29ee8ac3f8df337354a3f2f0bcd4a))
...
* resolve manage layout state reset and preview action ([6966666](https://github.com/lemonadesocial/web-new/commit/696666663eb7264fcad7853d8005b41040cc6dd8))
...
* resolve request changes ([81e5f98](https://github.com/lemonadesocial/web-new/commit/81e5f98e0262f7cdb65421f242b63c52aa531834))
* resolve request changes ([9ff1f53](https://github.com/lemonadesocial/web-new/commit/9ff1f534ae7aea847a37595156a08af087c82857))
* revert strict equality ([4239cc1](https://github.com/lemonadesocial/web-new/commit/4239cc178a58e2dc9c249d9ead45be31c7f74a00))
* revert useQuery workaround, restore useMutation for on-demand query ([46f06ac](https://github.com/lemonadesocial/web-new/commit/46f06ac5281dc83887c5604a6951c4023d341888))
* scope theme preview to manage content panel ([dddc39c](https://github.com/lemonadesocial/web-new/commit/dddc39cbf5c9be6e56d34ca14bf7f53293ca884c))
...
* show crypto savings amount on upgrade plans ([8aff876](https://github.com/lemonadesocial/web-new/commit/8aff876e03dc745eb6199bb672ae2fdce3d6b332))
...
* update ai cards unit tests to match new agent list and message structure ([ee3d9f1](https://github.com/lemonadesocial/web-new/commit/ee3d9f1bd40874cdd798dbeb08eee994883cb8c4))
* update layout payouts cards ([7935ff1](https://github.com/lemonadesocial/web-new/commit/7935ff10cff0276ae2fd65847cef01194f2c3862))
* update manage event button should open drawer from home page ([91c9691](https://github.com/lemonadesocial/web-new/commit/91c969148df88cb6812cd00d99eabdf1db4a0547))
...
* use event and community names in manage header ([365a339](https://github.com/lemonadesocial/web-new/commit/365a339aa921029cf65e10cd2a3acdc4f3ab680c))
